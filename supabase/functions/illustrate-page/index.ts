...
- SKIN TONE & LIGHTING HARD GATE (non-negotiable): the child and any other people MUST be rendered in their TRUE skin tone from the character sheet / cover / previous page reference, and MUST be clearly and warmly lit so face, eyes, and skin tone are fully visible. NEVER render a person as a silhouette, blacked-out shape, or lost in shadow or darkness, and NEVER darken, desaturate, or shift their skin tone. Even for evening, nighttime, sunset, dusk, campfire, or bedtime scenes, keep every character softly but clearly lit and in their full natural color — use warm lamplight, a bedside nightlight, a candle, moonglow, firelight, or interior light to illuminate faces and skin. Do not produce dim or dark scenes that reduce people to dark shapes. An image where any main character is silhouetted, blacked-out, or has darkened skin tone will be REJECTED and regenerated.
- NO TEXT ON OBJECTS: do not render letters, numbers, words, or text on blocks, books, signs, posters, packaging, clothing tags, or any other object in the image.
