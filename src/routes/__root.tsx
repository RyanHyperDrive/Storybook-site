...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "StoryNest — Personalized illustrated storybooks" },
      { property: "og:description", content: "Upload a photo, share what they love, approve the character. Custom ebook made for reading together." },
